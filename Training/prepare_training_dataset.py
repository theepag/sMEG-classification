...
print("input_part_one", len(input_part_one))
print("input_part_two", len(input_part_two))
print("train_encoded_labels", train_encoded_labels)
print("validate_part_one", len(validate_part_one))
print("validate_part_two", len(validate_part_two))
...
# Length and shape of X
print("Length of X (number of input parts for training):", len(X))
for i in range(len(X)):
    print(f"Shape of input part {i+1}: {X[i][0].shape}")  # Assuming each part has the same shape

# Length and shape of Y
print("\nLength and shape of Y (encoded labels for training):")
print("Shape of Y:", Y.shape)

# Length and shape of X_validate
print("\nLength of X_validate (number of input parts for validation):", len(X_validate))
for i in range(len(X_validate)):
    print(f"Shape of input part {i+1}: {X_validate[i][0].shape}")  # Assuming each part has the same shape

# Length and shape of Y_validate
print("\nLength and shape of Y_validate (encoded labels for validation):")
